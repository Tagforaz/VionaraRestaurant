        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderNotes = table.Column<string>(type: "nvarchar(800)", maxLength: 800, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryTrackings_Couriers_CourierId",
                        column: x => x.CourierId,
                        principalTable: "Couriers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryTrackings_CourierId",
                table: "DeliveryTrackings",
                column: "CourierId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryTrackings_CreatedAt",
                table: "DeliveryTrackings",
                column: "CreatedAt");
